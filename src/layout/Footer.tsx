                        ...
                        <div className="footer__contact">
                            ...
                            <ul className="footer__contact-list">
                                ...
                                <li className="footer__contact-item">
                                    <div className="footer__contact-icon">
                                        <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M5.66836 5.6687H28.3434C29.9023 5.6687 31.1777 6.94417 31.1777 8.50308V25.5093C31.1777 27.0682 29.9023 28.3437 28.3434 28.3437H5.66836C4.10945 28.3437 2.83398 27.0682 2.83398 25.5093V8.50308C2.83398 6.94417 4.10945 5.6687 5.66836 5.6687Z" stroke="white" strokeWidth={2.83437} strokeLinecap="round" strokeLinejoin="round"/>
                                            <path d="M31.1777 8.50317L17.0059 18.4235L2.83398 8.50317" stroke="white" strokeWidth={2.83437} strokeLinecap="round" strokeLinejoin="round"/>
                                        </svg>
                                    </div>
                                    <div className="footer__contact-content">
                                ...
                                <li className="footer__contact-item">
                                    <div className="footer__contact-icon">
                                        <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g clipPath="url(#clip0_1012_929)">
                                                <path d="M29.7613 14.1719C29.7613 24.0922 17.0066 32.5954 17.0066 32.5954C17.0066 32.5954 4.25195 24.0922 4.25195 14.1719C4.25195 10.7892 5.59575 7.54496 7.98771 5.153C10.3797 2.76103 13.6239 1.41724 17.0066 1.41724C20.3894 1.41724 23.6336 2.76103 26.0256 5.153C28.4175 7.54496 29.7613 10.7892 29.7613 14.1719Z" stroke="white" strokeWidth={2.83437} strokeLinecap="round" strokeLinejoin="round"/>
                                                <path d="M17.0064 18.4235C19.3545 18.4235 21.258 16.52 21.258 14.172C21.258 11.8239 19.3545 9.92041 17.0064 9.92041C14.6584 9.92041 12.7549 11.8239 12.7549 14.172C12.7549 16.52 14.6584 18.4235 17.0064 18.4235Z" stroke="white" strokeWidth={2.83437} strokeLinecap="round" strokeLinejoin="round"/>
                                            </g>
                                            <defs>
